...
% \section{References}
% \cvlistitem{Prof. Javier Tiffenberg (\url{javiert@fnal.gov}). Fermi National Accelerator Laboratory \& Department of Physics, Faculty of Exact and Natural Sciences, University of Buenos Aires.}
% \cvlistitem{Dr. Carla Bonifazi (\url{cbonifazi@unsam.edu.ar}). CBPF \& ICIFI-UNSAM.}
% \cvlistitem{Prof. Dario Rodrigues (\url{rodriguesfm@df.uba.ar}). Department of Physics, Faculty of Exact and Natural Sciences, University of Buenos Aires.}
...
\end{itemize}}
% \cventry{2023}{Brainhack School}{Buenos Aires branch.}{}{}{}
% \cventry{2022}{CS50's Introduction to Artificial Intelligence with Python.}{}{}{}{}
